...
if [ $(uname) = "Darwin" ]; then
  clang++ -c gamemaker.cpp cocoa.mm apiprocess/process.cpp -shared -std=c++17 -DPROCESS_GUIWINDOW_IMPL -framework CoreFoundation -framework CoreGraphics -ObjC++ -arch arm64 -arch x86_64 && clang++ gamemaker.o cocoa.o process.o -o libxprocess.dylib -shared -std=c++17 -DPROCESS_GUIWINDOW_IMPL -framework CoreFoundation -framework CoreGraphics -ObjC++ -arch arm64 -arch x86_64;
  ar rc libxprocess.a gamemaker.o cocoa.o process.o && rm -f "gamemaker.o" "cocoa.o" "process.o";
